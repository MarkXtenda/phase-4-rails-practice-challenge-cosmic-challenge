...
Planet.create(name: Faker::TvShows::StarTrek.unique.location,
...
Scientist.create(name: Faker::FunnyName.name,
                           field_of_study: Faker::Educator.subject,
                           avatar: Faker::Avatar.image(size: "200x200", set: "set3"))

puts "Making missions..."                           
Mission.create(name: Faker::TvShows::Buffy.unique.episode,
scientist_id: Scientist.last.id, 
planet_id: Planet.last.id)}
